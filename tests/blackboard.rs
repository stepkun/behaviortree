...
fn blackboard() {
    ...
    let old = blackboard.set("test", String::from("test")).expect("snh");
    assert_eq!(old, None);
...
fn blackboard_node_default() {
    ...
    let old = level0.set("test", String::from("test")).expect("snh");
    assert_eq!(old, None);
...
fn blackboard_node_with_parent() {
    ...
    let old = level0.set("test1", String::from("test1")).expect("snh");
    assert_eq!(old, None);
    let old = level0.set("test2", String::from("test2")).expect("snh");
    assert_eq!(old, None);
    ...
    let old = node.set("@other", String::from("other")).expect("snh");
    assert_eq!(old, None);

    let old = node.set("test3", String::from("test3")).expect("snh");
    assert_eq!(old, None);
...
fn blackboard_node_hierarchy() {
    ...
    let old = level0.set("levelA", String::from("testA")).expect("snh");
    assert_eq!(old, None);

    let old = level0.set("level0", String::from("test0")).expect("snh");
    assert_eq!(old, None);
    let old = level1.set("level1", String::from("test1")).expect("snh");
    assert_eq!(old, None);
    let old = level2.set("level2", String::from("test2")).expect("snh");
    assert_eq!(old, None);
    let old = level3.set("level3", String::from("test3")).expect("snh");
    assert_eq!(old, None);

    // test autoremap
    let old = level3.set("level2", String::from("changed2")).expect("snh");
    ...
    let old = level3.set("level0", String::from("changed0")).expect("snh");
    ...
    assert_eq!(value, String::from("testA"));
    let old = level3.set("levelD", String::from("changedD")).expect("snh");
